...
class CustomUserCreationForm(UserCreationForm):
    user_type = forms.ChoiceField(choices=UserType.choices, widget=forms.Select(attrs={'class': 'form-control'}))
    ...
    class Meta:
        model = Account
        fields = ('username', 'email', 'user_type', 'phone_number', 'street_address', 'city', 'state', 'country', 'zip_code', 'password1', 'password2')
...
class ProfileUpdateForm(forms.ModelForm):
    ...
    # Applicant-specific fields
    headline = forms.CharField(max_length=500, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    resume = forms.URLField(required=False, widget=forms.URLInput(attrs={'class': 'form-control'}))
    ...
    class Meta:
        model = Account
        fields = ('email', 'phone_number', 'profile_picture', 'street_address', 'city', 'state', 'country', 'zip_code')
